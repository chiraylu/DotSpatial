...
namespace DotSpatial.Data
{
    ...
    public abstract class Shapefile : FeatureSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Shapefile"/> class. This simply prevents the basic values from being null.
        /// </summary>
        protected Shapefile()
        {
            Configure();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Shapefile"/> class that has a specific feature type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Shapefile"/> class based on a fileName.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a general header structure that stores some basic information about the shapefile.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// </summary>
        /// <returns>An array with the columns.</returns>
        public override DataColumn[] GetColumns()
        {
            return _attributeTable.Columns.Select(_ => (DataColumn)new Field(_.ColumnName, _.TypeCharacter, _.Length, _.DecimalCount)).ToArray();
        }
        ...
        /// <summary>
        /// Gets the number of rows in the attribute table.
        /// </summary>
        ...
        {
            var prjFile = Path.ChangeExtension(Filename, ".prj");
            if (File.Exists(prjFile)) File.Delete(prjFile);
        ...
        /// <summary>
        /// This makes the assumption that the organization of the feature list has not changed since loading the attribute content.
        /// </summary>
        /// <param name="sender">Sender that indicated that the attributes where filled.</param>
        ...
        {
            /// <summary>
            /// Gets or sets the length of the shp file.
            /// </summary>
            internal int ShpLength { get; set; }

            /// <summary>
            /// Gets or sets the length of the shx file.
            /// </summary>
