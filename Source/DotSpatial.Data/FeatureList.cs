...
namespace DotSpatial.Data
{
    ...
    public class FeatureList : IFeatureList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureList"/> class where no parent is specified.
        /// This will basically simply act as a list and will not allow the features to be aware of the parent featureset.
        /// </summary>
        public FeatureList()
        {
            Configure();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureList"/> class where the ParentFeatureSet
        ...
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">DotSpatial.Interfaces.Framework.IEventList&lt;IFeature&gt;.Capacity is set to a value that is less than DotSpatial.Interfaces.Framework.IEventList&lt;IFeature&gt;.Count.</exception>
        ...
        /// </summary>
        public bool EventsSuspended => _suspension > 0;

        /// <summary>
        /// Gets or sets a value indicating whether the features will be added to the list without copying over attribute table information.
        ...
        /// <param name="count">The number of elements in the section to search.</param>
        /// <param name="match">A Predicate that defines the conditions of the element to search for.</param>
        ...
        /// </summary>
        /// <returns>An enumerator that iterates through this list.</returns>
        ...
        private void IncludeFeature(IFeature item, int index = -1)
        {
            ...
            if (IncludeAttributes)
            {
                ...
                if (item.DataRow != null)
                {
                    ...
                    {
                        string name = Parent.DataTable.Columns[col].ColumnName;
