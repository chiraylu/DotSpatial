...
namespace DotSpatial.Controls
{
    ...
    public class LayoutScaleBar : LayoutElement
    {
        ...
        public override void Draw(Graphics g, bool printing)
        {
            ...
            g.DrawString("1 : " + string.Format("{0:0,0}", Map.Scale), _font, scaleBrush, leftStart - (g.MeasureString(Math.Abs(geoBreakWidth * startBreak).ToString(), _font).Width / 2), fontHeight * 2.5F);
